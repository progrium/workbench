...
func main() {
	...
	d.HandleFunc(snowboy.NewHotword(os.Args[2], 0.4), func(string) {
		fmt.Println("Handle func for snowboy Hotword 0.4")
	})

	d.HandleFunc(snowboy.NewHotword(os.Args[2], 0.6), func(string) {
		fmt.Println("Handle func for snowboy Hotword 0.6")
	})
